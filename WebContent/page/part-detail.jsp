...
<head>
    <meta charset="UTF-8">
    <title>兼职信息-信息浏览</title>
    <link rel="stylesheet" type="text/css" href="../static/css/styleFastLogin.css">
...
<div>
    <header id="header">
        <nav>
            ...
            <div class="my-info" >
                <figure></figure>
                <span id="showLogin"> </span>                     <%--在这个页面显示是否登录,script中有控制显示--%>
            ...
            <section>
                ...
                <table class="yangshi">
						<tr>
							...
							<td style="font-size:20px">兼职信息名称：</td>
							<td style="font-size:20px">兼职需要人数：</td>
							<td style="font-size:20px">兼职具体要求：</td>
							<td style="font-size:20px">兼职价格：</td>
							<td style="font-size:20px">兼职情况：</td>
						</tr>
						<%
							List whh = (List) session.getAttribute("usedJob");
							Iterator it = whh.iterator();
							System.out.println("helllo1");
							
							while (it.hasNext()) {
							System.out.println("helllo1");
							usedJob t = (usedJob) it.next();
							
						%>
						<tr>
							<td style="font-size:20px"><%=t.getOwnerName() %></td>
							<td style="font-size:20px"><%=t.getJobIntro()%></td>
							<td style="font-size:20px"><%=t.getJobNumber() %></td>
							<td style="font-size:20px"><%=t.getJobRequire() %></td>
							<td style="font-size:20px"><%=t.getJobPrice()%></td>
							<td style="font-size:20px"><%=t.getJobState()%></td>
						</tr>
						<%
							}
						%>
