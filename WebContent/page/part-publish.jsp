	...
	<div>
		...
		<div id="container">
			...
			<article class="article">
				...
				<h1></h1>	
				<%
							if (request.getParameter("jobintro") == null)
							{
						%>
						<form action="../controller/addUsedJob.jsp" method="post">
							<%
								} else {
							%>
							<form action="../controller/updateUsedJob.jsp" method="post">
								<%
									}
								%>
							...
							<table cellpadding="0" cellspacing="0" width="480" border="0">
								...
								<tr>
									<td>兼职信息名称：</td>
									<td><input name="jobIntro" type="text" 
									value="${param.jobintro}"/><br>
									<br></td>
								</tr>
								<tr>
									<td>兼职需要人数：</td>
									<td><input name="jobNumber" type="text" value="${param.jobNumber}"/><br>
									<br></td>
								</tr>
								<tr>
									<td>兼职具体要求：</td>
									<td><input name="jobRequire" type="text" value="${param.jobRequire}"/><br>
									<br></td>
								</tr>
								<tr>
									<td>兼职价格：</td>
									<td><input name="jobPrice" type="text" value="${param.jobPrice}"/><br>
									<br></td>
								</tr>
								<tr>
									<td>兼职情况：</td>
									<td><input name="jobState" type="text" value="${param.jobState}"/><br>
									<br></td>
								</tr>
								<td colspan=2>
									<center>
