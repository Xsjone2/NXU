		...
		<div id="container">
			...
			<article class="article">
				<section>
					...
					<center>
						<%-- <c:choose>
				<c:when test="${param.thingsName}==null">
						<form action="../controller/addUsedThing.jsp" method="post">
				</c:when>
				<c:otherwise>
						<form action="../controller/updateUsedThing.jsp" method="post">
				</c:otherwise>
			</c:choose>--%>
						<%
							if (request.getParameter("thingsName") == null)
							{
						%>
						<form action="../controller/addUsedThing.jsp" method="post">
							<%
								...
								<table cellpadding="0" cellspacing="0" width="480" border="0">
									<tr>
										...
										<td><input name="OwnerName" type="text"
											value="${sessionScope.user.userName}"><br> <br></td>
									</tr>
									<tr>
										<td>旧物名称：</td>
										<td><input name="thingsName" type="text"
											value="${param.thingsName}" /><br> <br></td>
									</tr>
									<tr>
										<td>旧物价格：</td>
										<td><input name="thingsPrice" type="text"
											value="${param.thingsPrice}" /><br> <br></td>
									</tr>
									<tr>
										<td>旧物介绍：</td>
										<td><input name="thingsIntro" type="text"
											value="${param.thingsIntro}" /><br> <br></td>
									</tr>
									<tr>
										<td>联系电话：</td>
										<td><input name="OwnerPhone" type="text"
											value="${param.OwnerPhone}" /><br> <br></td>
									</tr>
									<tr>
										<td>旧物售出情况：</td>
										<td><input name="thingsState" type="text"
											value="${param.thingsState}" /><br> <br></td>
									</tr>
									<td colspan=2>
										<center>
