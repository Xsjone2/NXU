                ...
                <p style="text-align:center;color:#ccc;font-size:12px;margin-top:40px;">
                	...
                	<table class="yangshi">
						<tr>
							...
							<td style="font-size:20px">失物/拾物名称</td>
							<td style="font-size:20px">失物/拾物信息简介</td>
							<td style="font-size:20px">失物/拾物地点</td>
							<td style="font-size:20px">失物/拾物情况</td>
						</tr>
						<%
						
						   List whh = (List) session.getAttribute("usedLost");	
							...
							usedLost t = (usedLost) it.next();

						%>
						<tr>
							<td style="font-size:20px"><%=t.getOwnerName()%></td>
							<td style="font-size:20px"><%=t.getLostName()%></td>
							<td style="font-size:20px"><%=t.getLostIntro()%></td>
							<td style="font-size:20px"><%=t.getLostPickup()%></td>
							<td style="font-size:20px"><%=t.getLostState()%></td>
						</tr>
						<%
							}
						%>
